...
@section('content')
	...
	<div class="row">
	    <form class="col s6 offset-s3" method="POST" action="{{ route('users.update', ['user' => $user->id]) }}">
	    	{{ method_field('PUT') }}
	    	{{ csrf_field() }}
	      <div class="row">
	        <div class="input-field col s12">
	          <input id="name" name="name" type="text" class="validate" value="{{ old('name', $user->name) }}">
	      ...
	      <div class="row">
	        <div class="input-field col s12">
	          <input id="email" name="email" type="email" class="validate" value="{{ old('email', $user->email) }}">
